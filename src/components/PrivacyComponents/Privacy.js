      ...
      <Section>
        ...
        <Wrapper>
          ...
          <Text>
            ...
            Resonate LTD ('we', 'us', 'our') collect, use and are responsible
            for storing certain personal information about you ('you', 'your',
            'yours'). Resonate LTD ('we', 'us', 'our') collect, use and are
            responsible for storing certain personal information about you
            ('you', 'your', 'yours').s is extremely important to us and
            therefore we encourage all users to read this policy very carefully
            because it contains important information regarding:who we are;how
            and why we collect, store, use and share personal information;your
            rights in relation to your personal information; and how to contact
            us and supervisory authorities in the event that you have a
            complaint.
          </Text>
          ...
          <Text>
            1. Types of personal information We may process the following types
            of personal information in relation to you: Contact details such us:
            email addresses, full names or telephone numbers
          </Text>
          <SubTitile>How your personal information is collected</SubTitile>
          <Text>
            This section describes how the above types of personal information
            are collected by us. Your personal information will be collected as
            follows:
          </Text>
          <Text>
            1. Personal information obtained from you directly We will sometimes
            obtain information from you directly, including when you:subscribe
            to the newsletter or contact us using the contact forms or chat
            service.
          </Text>
          <Text>
            2. Changes to the way in which we collect your personal information
            In the event that we need to obtain personal information in relation
            to you from any other source than those described above, we shall
            notify you of this.
          </Text>
          ...
          <Text>
            ...
            undertake monitoring in the following circumstances: Emails and
            forms submissions can be monitored for quality assurance.
          </Text>
          <SubTitile>How we use your personal information</SubTitile>
          <Text>
            We have described above the purposes for which we may process your
            personal information. These purposes will at all times be justified
            by data protection law.
          </Text>
          <Text>1. General lawful bases</Text>
          <Text>
            The lawful basis upon which we are able to process your personal
            data are:
          </Text>
          <Text>
          ...
          <Text>
            (6) where it is needed in the public interest (or where we are
            acting in our official functions), provided that the task or
            function has a clear basis in law.
          </Text>
          <Text>
            In general, in order to meet the purposes we have described above,
            we will process your personal information where it is necessary to
            comply with legal obligations which we are required to adhere to.
          </Text>
          <Text>
            2. Lawful bases specifically applicable to marketing We will only
            ever use your personal information to send you marketing directly
            where we have your explicit consent (which will be obtained in a
            format separately to this policy).
          </Text>
          <SubTitile>Sharing of your personal information</SubTitile>
          <Text>
            On any occasion where any of your personal information is shared
            with any third party, we shall only permit them to process such
            information for our required purposes, under our specific
            instruction, and not for their own purposes. We are required to
            enter into a formal legal agreement to enable such sharing to take
            place.
          </Text>
          ...
          <Text>
            ...
            breach, which shall be reported and dealt with in accordance with
            data protection laws and regulations. You shall also be notified of
            any suspected data breach concerning your personal information.
          </Text>
          ...
          <Text>
            (8) object in certain other situations to our continued processing
            of your personal information, or ask us to suspend the processing
            procedure in order for you confirm its assurance or our reasoning
            for processing it;
          </Text>
          <Text>
          ...
          <Text>
            (10) otherwise restrict our processing of your personal information
          ...
          <Text>
            ...
            processing personal information, you may withdraw this consent at
            any time.
          </Text>
          <Text>
